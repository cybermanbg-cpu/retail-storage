...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6 text-center">
            ...
            <div class="text-2xl font-bold text-green-600">{{ number_format(collect($report)->sum('revenue'), 2) }} лв.</div>
            <div class="text-gray-600">Общ приход</div>
        </div>
        
        <div class="bg-white rounded-lg shadow p-6 text-center">
            <div class="text-3xl text-red-500 mb-2">📦</div>
            <div class="text-2xl font-bold text-red-600">{{ number_format(collect($report)->sum('costs'), 2) }} лв.</div>
            <div class="text-gray-600">Общи разходи</div>
        </div>
        
        <div class="bg-white rounded-lg shadow p-6 text-center">
            <div class="text-3xl text-blue-500 mb-2">📈</div>
            <div class="text-2xl font-bold text-blue-600">{{ number_format(collect($report)->sum('profit'), 2) }} лв.</div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm text-right text-red-600">{{ number_format($item['costs'], 2) }} лв.</td>
